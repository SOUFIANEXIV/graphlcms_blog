...
className='object-top absolute h-80 w-full object-cover shadow-lg rounded-t-lg lg:rounded-lg'
  />
      ...
      hover:text-blue-600 text-2xl font-semibold'>
...
<p className='inline align-middle text-gray-400 ml-2 text-lg'>
  {post.author.name}
      ...
      <p className='text-center overflow-x-clip text-lg text-gray-700 font-normal px-4 lg:px-20 mb-8'>
        {post.excerpt}
      </p>
      <div className='text-center'>
        <Link href={`/post/${post.slug}`}>
          <span className='transition duration-300 transform hover:-translate-y-1
          inline-block bg-red-500 text-lg font-medium rounded-full
